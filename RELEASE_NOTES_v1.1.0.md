# Release Notes - Microsistemas v1.1.0

**Fecha de lanzamiento**: 19 de enero de 2026

## 🎉 Resumen Ejecutivo

La versión **1.1.0** introduce **CapacitySim Pro**, una evolución significativa del simulador de capacidad que ahora incluye simulación de costos multi-cloud, modo comparativo de escenarios y exportación profesional de reportes. Estas características transforman CapacitySim de una herramienta educativa a una solución completa para planificación de capacidad empresarial.
...
- **Tiempo de desarrollo**: Basado en conversación del 19/01/2026
