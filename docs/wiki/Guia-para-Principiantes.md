...
* **Que hay dentro?**: Una carpeta por cada herramienta (ej. `SqlViewer/`, `CicdLibrary/`, `Conversor/`).
...
* **Para el novato**: Es como tener un robot invisible que limpia y organiza tu proyecto cada vez que tu terminas de trabajar.
