...
/**
 * Divide un string en líneas, eliminando espacios en blanco.
 */
function lines(s) { return String(s || "").split(/\r?\n/).map(x => x.trim()); }

/**
 * Parsea un string multilínea de tipo clave=valor en un objeto.
 */
function kvLines(s) {
  const obj = {};
...
/**
 * Convierte un objeto JS a formato YAML string.
 */
